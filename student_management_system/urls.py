...
urlpatterns = [
    ...
    path('staff_feedback_message_replied', HodViews.student_leave_view, name="student_leave_view"),
    path('student_leave_view', HodViews.staff_feedback_message_replied, name="staff_feedback_message_replied"),
    ...
    path('student_disapprove_leave/<str:leave_id>', HodViews.student_disapprove_leave, name="student_disapprove_leave"),  path('student_approve_leave/<str:leave_id>', HodViews.student_approve_leave, name="student_approve_leave"),
